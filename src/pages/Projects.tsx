          ...
          <div className="p-6 sm:p-8 lg:p-10 space-y-4 sm:space-y-6">
            <div>
              <div className="flex items-center justify-between gap-3 mb-2">
                <h2 className="text-2xl sm:text-3xl font-bold gradient-text flex-1">{proj.title}</h2>
                <a
                  href={proj.github}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-white/10 hover:bg-white/20 transition-all duration-200 flex-shrink-0 hover:scale-110 active:scale-95 cursor-pointer"
                  title="View on GitHub"
                >
                  <svg className="w-5 h-5 sm:w-6 sm:h-6 text-white/80 hover:text-white" fill="currentColor" viewBox="0 0 24 24">
